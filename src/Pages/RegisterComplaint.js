...
function RegisterComplaint(props) {
  ...
  const onSubmit = (data) => {
    ...
    fetch(
      `https://api.payemi.net/registerComplaint/?transaction_ref_id=${data.ref_id}&complaint_disposition=${data.dispostion}&complaint_description=${data.description}&complaint_type=Transaction`,
      {
        method: "POST",
        headers: {
        ...
        <div className="home-main header-second">
          ...
          <div className="d-flex align-center justify-between px-4">
            <div className="d-flex align-center position-relative head-info">
              ...
              <p className="mb-0">Register Complaint</p>
            </div>
            <div>
              ...
              >
                ...
                <div className="row mb-4">
                  <div className="col-12">
                    ...
                    <select
                      {...register("dispostion", { required: true })}
                      className="form-select"
                    >
                      <option value="">Select Disposition</option>
                      <option value="Transaction Successful, account not updated">
