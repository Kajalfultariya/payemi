...
function Home(props) {
  ...
  const [userPaymentInfo, setUserPayementInfo] = React.useState();
  const [loading, setLoading] = React.useState(true);
  useEffect(() => {
    fetch(
      `https://api.payemi.net/billfetch/?id=2&biller_id=ICIC00000NATKD&mobile=9898990861`,
      {
        method: "POST",
        headers: {
      ...
      .then((res) => res.json())
      .then((data) => {
        setUserPayementInfo(data.payload);
        setLoading(false);
      });
  }, []);
  ...
  const [Notification, NotificationsetOpen] = React.useState(false);
  const NotificationClickOpen = () => {
    NotificationsetOpen(true);
  };
  const NotificationClose = () => {
    NotificationsetOpen(false);
  };

  // handleConfirmationPay
  const handleConfirmationPay = () => {
    BillPaySixsetOpen(true);
  };
  const BillPaySevenClickOpen = (e) => {
    // razor pay
    const options = {
      key: "rzp_test_a9DQDSDQfs10TS",
      amount: userPaymentInfo?.map((data) => parseInt(data.amount) + "00"),
      currency: "INR",
      name: "Acme Corp",
      // order_id: `${userPaymentInfo?.order_id}`,
      handler: function (response) {
        alert(response.razorpay_payment_id);
        localStorage.setItem("data", JSON.stringify(userPaymentInfo));
      ...
      <div className={open1 ? "menu-close" : "menu-open"}>
        <div className="home-main">
          ...
          <div className="d-flex align-center justify-between home-header px-4">
            ...
            <div className="d-flex align-center position-relative head-info">
              <div onClick={NotificationClickOpen}>
                <svg
                  width="31"
                  height="31"
                  viewBox="0 0 31 31"
                ...
                <div className="col-12">
                  ...
                  <div className="home-card">
                    <div className="d-flex justify-between mb-4">
                      <Link to="/transaction-history" className="d-flex">
                        <img src={Hdfc} />
                        <div>
                          <p className="mb-0">ICICI Bank Limited</p>
                        </div>
                      </Link>
                      <div>
                        <p className="mb-0 text-black">
                          <strong>Rs. 37,378</strong>
                        </p>
                      </div>
                    </div>
                    <hr />
                    ...
                    <div className="mb-0 mt-3">
                      <p className="mb-0 text-center">
                        <a onClick={MissinginfoClickOpen}>
            ...
            <AppBar sx={{ position: "relative" }} className="side-pane-header">
              <div className="d-flex align-center justify-between">
                <div onClick={BillPayFourClose} className="d-flex align-center">
                  ...
                  <div>
                    <p className="m-0">HDFC Bank Limited</p>
              ...
              <div className="py-3 px-3">
                <div className="row">
                  ...
                  <div className="col-10">
                    ...
                    <p className="m-0">
                      {userPaymentInfo?.map((data) => parseInt(data.amount)) ||
                        0}
                    </p>
                  </div>
                </div>
                    ...
                    <div className="col-12">
                      ...
                      <div className="w-auto d-flex align-center">
                        ...
                        <input
                          ...
                          type="text"
                          value={
                            userPaymentInfo?.map((data) => data.amount) || 0
                          }
            ...
            <div className="modal-half-content pb-4 px-4">
              <div className="py-0 mb-4">
                ...
                <p className="mb-0 tx-12 text-black">
                  Axis Finance Loan Account Number - 1267232231627
                </p>
              </div>
              <div className="row mb-4">
                <div className="col-12">
                  <label for="Type" className="col-form-label pt-0">
                    Loan Type
                  </label>
                  <select className="form-select">
                    <option value="">Select</option>
                    <option value="">Loan Type 1</option>
                    <option value="">Loan Type 2</option>
                  </select>
                </div>
              </div>
              <div className="row mb-4 position-relative mobile-otp">
                <div className="col-12">
                  <label for="Loan" className="col-form-label pt-0">
                    Loan Amount
                  </label>
                  <input name="Loan" type="text" className="form-control" />
                </div>
              </div>
              <div className="row mb-4 position-relative mobile-otp">
                <div className="col-12">
                  <label for="EMI" className="col-form-label pt-0">
                    EMI
                  </label>
                  <input name="EMI" type="text" className="form-control" />
                </div>
              </div>
              <div className="row mb-4 position-relative mobile-otp">
                <div className="col-12">
