          ...
          <div className="home-base">
            <div className="home-content px-3">
              <div className="row">
                                ...
                                <div className="PendEmi">
                                  <p className="mb-0 text-black">
                                    <strong>
                                      Rs.{"  "}
                                      {!item?.emi ? (0) :
                                      (numberWithCommas(item?.emi))}
                                    </strong>
                                  </p>
                                  <spna>Pending EMI</spna>
                                </div>
                              </div>
                                        ...
                                        <div className="col-6">
                                          ...
                                          >
                                            {Array.from(new Array(15), (v, i) =>
                                              <option key={i} value={yearM - i}>{yearM - i}</option>
                                            )}
                ...
                {homeData?.length === 0 ? (<><h3 className="text-center w-100" style={{ color: "Black" }}>
                  No Records Found....
                </h3></>) : (<></>)}
                <div className="col-12" style={{ paddingTop: "15px" }}>
                  <p>Our Esteemed Clients</p>
                  <div className="our-clients d-flex align-center">
                    <div>
                      <img src={HdfcClient} />
                    </div>
                    <div>
