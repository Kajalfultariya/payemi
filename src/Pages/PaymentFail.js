...
const Main = styled("main", { shouldForwardProp: (prop) => prop !== "openq" })(
  ({ theme, openq }) => ({
    flexGrow: 1,
...
function PaymentFail(props) {
  ...
  const [Transactionopen, TransactionsetOpen] = React.useState(false);
  const TransactionClickOpen = () => {
    TransactionsetOpen(true);
  };
  const TransactionClose = () => {
    TransactionsetOpen(false);
  };

  {
    /* Payment Processing */
  }
  const [Processingopen, ProcessingsetOpen] = React.useState(false);
  const ProcessingClickOpen = () => {
    ProcessingsetOpen(true);
  };
  const ProcessingClose = () => {
    ProcessingsetOpen(false);
  };

  {
    /* Payment Failed */
  }
  const [Failedopen, FailedsetOpen] = React.useState(false);
  const FailedClickOpen = () => {
    FailedsetOpen(true);
  };
  const FailedClose = () => {
    FailedsetOpen(false);
      ...
      <div className="home-main h-100">
        <div className="d-flex align-center justify-between header-white px-4">
          <div className="d-flex align-center">
            ...
            <div className="d-flex align-center ms-2">
              <img width={20} src={Hdfc} />
              <div>
                <p className="mb-0 lh-1 tx-14 ms-2">HDFC Bank Limited</p>
        ...
        <div className="home-base home-base-notification h-100">
          <div className="home-content px-3 pt-2">
              ...
              <div className="col-12">
                <div className="py-0 px-0 text-center mb-2">
                  <p className="mb-1 tx-12 time-stamp">
                    <span>15 Oct 6:24 PM</span>
                  </p>
                </div>
              </div>
              <div className="col-7">
                <div className="home-card" onClick={TransactionClickOpen}>
                  <div className="mb-3">
                    <div className="d-flex align-center ">
                      <div>
                  ...
                  <div>
                    <p className="mb-1 tx-24 font-500 text-black">Rs. 14,288</p>
                  </div>
            ...
            <div className="row">
              <div className="col-7">
                <div className="home-card" onClick={FailedClickOpen}>
                  <div className="mb-3">
                    <div className="d-flex align-center ">
                      <div>
                        <p className="mb-1 lh-1 text-black">
            ...
            <div className="row justify-content-end">
              <div className="col-7">
                <div className="home-card px-0 pb-0">
                  ...
                  <div className="mt-3">
                    <img className="ScratchCard" src={ScratchCard} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-7">
                <div className="home-card" onClick={ProcessingClickOpen}>
                  <div className="mb-3">
                    <div className="d-flex align-center ">
                      <div>
                        <p className="mb-1 lh-1 text-black">
        ...
        >
              ...
              <div className="d-flex align-center">
                ...
                <div>
                  <Button
                    id="demo-positioned-button"
                    aria-controls={
                      BooleanOpen ? "demo-positioned-menu" : undefined
                    }
                    aria-haspopup="true"
                    aria-expanded={BooleanOpen ? "true" : undefined}
                    onClick={handleClick}
              ...
              <div className="bg-gray px-4 py-4">
                <div className="row mb-3">
                  <div className="col-12">
                    ...
                    <p className="m-0 text-black">123456789009</p>
                  </div>
                </div>
                <div className="row mb-3">
                  <div className="col-12">
                ...
                <div className="row mb-3">
                  <div className="col-12">
                    <p className="m-0 pe-3 text-black">
                      From - Ritu Raj Srivastava
                    </p>
                    <p className="m-0 text-black">hirituraj@gmail.com</p>
                  </div>
                </div>
                <div className="row mb-0">
                  <div className="col-12">
                    <p className="m-0 pe-3 text-black">Biller Id - 1234567</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="row mb-3 mt-4 px-4 pt-0">
          ...
          <div className="row mb-4 mt-0 px-4">
            <div className="col-3">
        ...
        <Dialog
          fullScreen
          open={Processingopen}
          onClose={ProcessingClose}
          TransitionComponent={TransitionUp}
          className="side-pane side-pane-second"
        >
          <AppBar sx={{ position: "relative" }} className="side-pane-header">
            <div className="d-flex align-center justify-between">
              <div onClick={ProcessingClose} className="d-flex align-center">
                <svg
                  width="21"
                  height="21"
                  viewBox="0 0 21 21"
