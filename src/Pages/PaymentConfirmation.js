...
function PaymentConfirmation(props) {
  ...
  const userPaymentInfo = JSON.parse(data);
  console.log(userPaymentInfo);
  // id
  const id = userPaymentInfo?.map((data) => data.id);
  //  biller id
  const biller_id = userPaymentInfo?.map((data) => data.biller_id);
  ...
  const handleOpen = () => {
    setOtpOpen(true);
    fetch(`https://api.payemi.net/ScratchCard/?id=${id}&bill_id=${biller_id}`, {
      method: "POST",
      headers: {
                ...
                <div className="col-12">
                  ...
                  <div className="w-auto d-flex align-center justify-center mb-2">
                    ...
                    <p className="tx-24 mb-0 me-2 text-black weight-700 weight-300 lh-1">
                      <strong>
                        {userPaymentInfo?.map((data) => data.amount)}
                      </strong>
                    </p>
                  </div>
                  <p className="mb-0 text-center">Amount Paid to HDFC Bank</p>
                </div>
              </div>
              <div className="row mb-5">
                <div className="col-12">
                ...
                <>
                    ...
                    {data["Transaction ID"] && (
                      <div className="col-12">
                        <div className="d-flex align-center justify-between">
                          ...
                          <p className="m-0">
                            <strong>{data["Transaction ID"]}</strong>
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  {data["customer_name"] && (
                    <div className="row mb-3">
                      <div className="col-12">
                        <div className="d-flex align-center justify-between">
                          <p className="m-0 pe-3">Customer Name</p>
                          <p className="m-0">
                  ...
                  {data["transaction_date_and_time"] && (
                    <div className="row mb-3">
                      <div className="col-12">
                        <div className="d-flex align-center justify-between">
                          <p className="m-0 pe-3">Transaction Date and Time</p>
                          <p className="m-0">
                    ...
                    <div className="row mb-3">
                      <div className="col-12">
                        <div className="d-flex align-center justify-between">
                          ...
                          <p className="m-0">
                            <strong>{data["Approval Number"]}</strong>
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row mb-3">
                      <div className="col-12">
                        <div className="d-flex align-center justify-between">
                          ...
                          <p className="m-0">
                            <strong>{data["Bill Amount"]}</strong>
                          </p>
                        </div>
                      </div>
                    </div>
                  )}
                  {data["Customer Convenience Fees"] && (
                    <div className="row mb-3">
                      <div className="col-12">
                        <div className="d-flex align-center justify-between">
                          <p className="m-0 pe-3">Customer Convenience Fees</p>
                          <p className="m-0">
                            <strong>{data["Customer Convenience Fees"]}</strong>
                          </p>
                        </div>
                      </div>
                    </div>
