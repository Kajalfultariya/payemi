...
const DomainPayEmiProcessing = () => {
  ...
  useEffect(() => {
    setInterval(() => {
      ...
      if (ApiCount < 6) {
        fetch(
          `https://api.payemi.net/getbilldetails-noauth/?bill_id=${biller_id}`,
          {
            method: "GET",
            headers: {
            ...
            if (data?.error) {
              ...
              if (status == "SU") {
                ...
                if (count === 5) {
                  swal({
                    title: "Pending!",
                    text: "Still Now Your Payement is Pending Now! So please Go to the home Page then you can see your payement status",
                    icon: "warning",
                    button: "Ok",
                  }).then(() => {
      ...
      <div className="row mb-5">
        <div className="col-12">
          ...
          <p className="mb-0 text-center text-black">
            To{"  "}
            {JSON.parse(localStorage.getItem("currentBankBranch"))?.billerName}
            Bank Limited
          </p>
                    ...
                    <div className="d-flex align-center justify-between">
                      ...
                      <p className="m-0">
                        <strong>
                          ...
                          {
                            JSON.parse(
                              localStorage.getItem("currentBankBranch")
                            )?.billerName
                          }{" "}
                          Bank
                        </strong>
...
export default DomainPayEmiProcessing;
