...
const SubDomainPayemiFailure = () => {
  ...
  useEffect(() => {
    if (bill_id) {
      fetch(
        `https://api.payemi.net/getbilldetails-noauth/?bill_id=${bill_id}`,
        {
          method: "GET",
        }
      )
                ...
                <div className="row mb-3">
                  <div className="col-12">
                    ...
                    <p className="mb-0 text-center text-black">
                      <span>To </span> {guest_biller_info?.billerName} Bank
                      Limited
                    </p>
...
export default SubDomainPayemiFailure;
