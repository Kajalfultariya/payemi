...
import AdminCampaignmanage from "./Admin/Pages/AdminCampaignmanage";
import AdminCampaignPerformance from "./Admin/Pages/AdminCampaignPerformance";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (sub.length > 0) setSubDomain(sub[0]);
  }, [subDomain]);
  ...
  useEffect(() => {
    ...
    sessionStorage.getItem("admin_medius_x_token") &&
      (axios.defaults.headers.common[
        "Authorization"
      ] = `Token ${sessionStorage.getItem("admin_medius_x_token")}`);
    sessionStorage.getItem("agent_medius_x_token") &&
      (axios.defaults.headers.common[
        "Authorization"
      ] = `Token ${sessionStorage.getItem("agent_medius_x_token")}`);
    axios.defaults.params = {};
    sessionStorage.getItem("admin_medius_x_token") &&
      (axios.defaults.params["client_id"] = sessionStorage.getItem(
        "admin_medius_x_clientID"
      ));
    sessionStorage.getItem("agent_medius_x_token") &&
      (axios.defaults.params["client_id"] = sessionStorage.getItem(
        "agent_medius_x_clientID"
      ));
      ...
      <Switch>
        ...
        {sessionStorage.getItem("admin") && (
          <Route>
            <aside
              className={`${
                IsSideBarOpen ? "sidebar" : "sidebar sidebar-hide"
              }`}
            >
              <AdminSidebar
            ...
            <section
              className={`${
                IsSideBarOpen ? "content" : "content content-full"
              }`}
            >
              <AdminHeader
                setIsSideBarOpen={setIsSideBarOpen}
              ...
              <div className="content-part">
                <Switch>
                  ...
                  <Route exact path="/admin/campaign/manage">
                    <AdminCampaignmanage />
                  </Route>

                  <Route exact path="/admin/campaign/performance">
              ...
              >
                ...
                <div className="content-part">
                  <Switch>
                    ...
                    <Route
                      exact
                      path="/admin/dashboard/reset-campaign/batch=:id"
                    >
                      <AdminBatchReset />
                    </Route>
